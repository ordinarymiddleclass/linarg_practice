"""
    cohen_10_1.py
    ~~~~~~~~~~~~~~~~
    Code challenge from Mike X Cohen's linear algebra book chapter 10, problem 1, with singular matrix.
"""
import numpy as np
import numpy.linalg as la
import random
import sys
sys.stdout = open("cohen_10_1_singular_output.txt", "w")
...
# Generate first two rows of a random 3x3 matrix with integer values between 1 and 10
A = np.array([[random.randint(1,10) for _ in range(3)] for _ in range(2)])
# Generate the third row of the matrix to make it singular
