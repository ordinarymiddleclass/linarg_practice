"""
    cohen_12_2.py
    ~~~~~~~~~~~~~~~~
    Code challenge from Mike X Cohen's linear algebra book chapter 12, problem 2.
    This is a code that compares the inverse from MCA algorithm vs numpy pseudo-inverse.
"""
import numpy as np
import numpy.linalg as la
import random
import sys
sys.stdout = open("cohen_12_2_output.txt", "w")
...
if __name__ == "__main__":    
    ...
    print("\nInverse of A using la.inv:")
    print(la.inv(A))
    print("\npseudoinverse of A using la.pinv:")
    print(la.pinv(A))